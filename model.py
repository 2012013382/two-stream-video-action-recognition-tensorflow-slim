...
def two_stream_model(rgb_image, flow_image, model_name, num_classes, keep_prob, batch_size, FRAMES_PER_VIDEO, is_training=True, stream_type='two_stream'): 
